...
export type ContractMsgCreateContractFileResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryContractFileAll = (
    ...
    this.request<ContractQueryAllContractFileResponse, RpcStatus>({
   ...
   */
  queryContractFile = (index: string, params: RequestParams = {}) =>
    this.request<ContractQueryGetContractFileResponse, RpcStatus>({
      path: `/firmachain/firmachain/contract/contractFile/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryContractLogAll = (
    ...
    this.request<ContractQueryAllContractLogResponse, RpcStatus>({
   ...
   */
  queryContractLog = (id: string, params: RequestParams = {}) =>
    this.request<ContractQueryGetContractLogResponse, RpcStatus>({
      path: `/firmachain/firmachain/contract/contractLog/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryIsContractOwner = (query?: { fileHash?: string; ownerAddress?: string }, params: RequestParams = {}) =>
    this.request<ContractQueryIsContractOwnerResponse, RpcStatus>({

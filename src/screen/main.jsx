  ...
  return (
    <>
      <Container>
        ...
        <ContentsContainer>
          ...
          <MainBox>
            ...
            <MainButtonBox>
              <MainButtonWrapper>
                <Button className={classes.main_button} variant='contained' onClick={() => setOpenWalletDrawer(true)}>
                  wallet
                </Button>
                <Button className={classes.main_button} variant='contained' onClick={() => setOpenRecoverDrawer(true)}>
                  Recover
                </Button>
                <Button
          ...
          <FooterBox>
            <Typography className={classes.footer_text} variant='body1'>
              Copyright © FIRMACHAIN 2023
            </Typography>
            <Typography className={classes.footer_text} variant='body1'>
              Maintained By{' '}
      ...
      <UtilsContext.Provider value={{ handleAlertOpen, handleLoadingOpen }}>
        ...
        <RecoverDrawer
          open={openRecoverDrawer}
          handleRecoverDrawer={handleRecoverDrawer}
          handleWalletDrawer={handleWalletDrawer}
        />
        {NftState.nftMode && <NftDrawer open={openNftDrawer} handleNftDrawer={handleNftDrawer} />}
